    ...
    <div class="sidebar-wrapper active">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                {{-- Item Menu Order Saya (Menggantikan Booking Saya) --}}
                <li class="sidebar-item {{ request()->routeIs('customer.orders.*') ? 'active' : '' }}">
                    {{-- Link ke halaman daftar order customer --}}
                    <a href="{{ route('customer.orders.index') }}" class="sidebar-link">
                        <i class="bi bi-receipt-cutoff"></i> {{-- Icon yang lebih cocok untuk order/transaksi --}}
