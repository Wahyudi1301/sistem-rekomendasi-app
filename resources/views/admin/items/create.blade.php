...
@section('page-title', 'Tambah Item AC Baru')

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="{{ route('admin.items.index') }}">Kelola Items AC</a></li>
    <li class="breadcrumb-item active" aria-current="page">Tambah Item AC</li>
@endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Form Tambah Item AC Baru</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.items.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <small class="form-text text-muted">Maks 2MB (jpg, png, gif, svg, webp).</small>
                                        @error('img') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        <img id="image-preview" src="#" alt="Preview Gambar" class="mt-2 img-thumbnail" style="max-height: 150px; display: none;" />
                                    </div>
                                    <hr>
                                    <h6 class="mt-3">Atribut Spesifik AC</h6>
                                     <div class="form-group mb-3">
                                        <label for="btu_capacity" class="form-label">Kapasitas BTU</label>
                                        <input type="number" class="form-control @error('btu_capacity') is-invalid @enderror" id="btu_capacity" name="btu_capacity" value="{{ old('btu_capacity') }}" min="0" placeholder="Contoh: 5000, 9000">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="number" class="form-control @error('power_consumption_watt') is-invalid @enderror" id="power_consumption_watt" name="power_consumption_watt" value="{{ old('power_consumption_watt') }}" min="0" placeholder="Contoh: 330, 780">
                                        @error('power_consumption_watt') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                    </div>

                                    <div class="form-check mb-3">
                                        <input class="form-check-input" type="checkbox" name="is_inverter" id="is_inverter" {{ old('is_inverter') ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_inverter">Tipe Inverter</label>
                                    </div>

                                    <div class="form-group mb-3">
                                        <label for="freon_type" class="form-label">Jenis Freon</label>
                                        <input type="text" class="form-control @error('freon_type') is-invalid @enderror" id="freon_type" name="freon_type" value="{{ old('freon_type') }}" placeholder="Contoh: R32, R410A">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('main_attribute_1_name') is-invalid @enderror" id="main_attribute_1_name" name="main_attribute_1_name" value="{{ old('main_attribute_1_name') }}" placeholder="Nama Atribut 1">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control @error('main_attribute_1_value') is-invalid @enderror" id="main_attribute_1_value" name="main_attribute_1_value" value="{{ old('main_attribute_1_value') }}" placeholder="Nilai Atribut 1">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('main_attribute_2_name') is-invalid @enderror" id="main_attribute_2_name" name="main_attribute_2_name" value="{{ old('main_attribute_2_name') }}" placeholder="Nama Atribut 2">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control @error('main_attribute_2_value') is-invalid @enderror" id="main_attribute_2_value" name="main_attribute_2_value" value="{{ old('main_attribute_2_value') }}" placeholder="Nilai Atribut 2">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('main_attribute_3_name') is-invalid @enderror" id="main_attribute_3_name" name="main_attribute_3_name" value="{{ old('main_attribute_3_name') }}" placeholder="Nama Atribut 3">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control @error('main_attribute_3_value') is-invalid @enderror" id="main_attribute_3_value" name="main_attribute_3_value" value="{{ old('main_attribute_3_value') }}" placeholder="Nilai Atribut 3">
                                    @error('main_attribute_3_value') <div class="invalid-feedback">{{ $message }}</div> @enderror
                                </div>
                            </div>

                            <div class="mt-4">
                                <button type="submit" class="btn btn-primary">Simpan Item AC</button>
