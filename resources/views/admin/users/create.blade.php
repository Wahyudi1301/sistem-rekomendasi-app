...
@section('page-title', 'Tambah User Baru (Admin/Staff)')
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <p class="text-muted">Isi semua field yang bertanda <span class="text-danger">*</span> untuk membuat user Admin atau Staff.</p>
                    </div>
                    <div class="card-body">
                        @include('admin.partials.alerts') {{-- Pastikan path ini benar untuk notifikasi --}}
                        ...
                        <form action="{{ route('admin.users.store') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="tel" name="phone_number" id="phone_number" class="form-control @error('phone_number') is-invalid @enderror" value="{{ old('phone_number') }}" placeholder="Contoh: 081234567890">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select @error('role') is-invalid @enderror" id="role" name="role" required>
                                            ...
                                            {{-- Variabel $roles di-pass dari UserController@create --}}
                            ...
                            <div class="mt-4">
                                <button type="submit" class="btn btn-primary"><i class="bi bi-save-fill me-2"></i>Simpan User</button>
